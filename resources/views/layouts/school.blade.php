...
<body class="min-h-screen mesh-bg font-sans antialiased">
                ...
                <div class="flex items-center gap-4 md:gap-8 min-w-0">
                    ...
                    <nav class="hidden md:flex items-center gap-6">
                        @if(auth()->user()->isStudent())
                            ...
                            <a href="{{ route('school.timetable.index') }}" class="nav-link {{ request()->routeIs('school.timetable.*') ? 'active' : '' }}">Timetable</a>
                ...
                @php
                    ...
                    if (auth()->user()->isStudent()) {
                        $mobileNavItems = array_merge($mobileNavItems, [
                            ...
                            ['route' => 'school.timetable.index', 'active' => 'school.timetable.*', 'label' => 'Timetable', 'icon' => 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0V11.25c0-1.243 1.007-2.25 2.25-2.25h13.5c1.243 0 2.25 1.007 2.25 2.25v7.5'],
    ...
    <nav class="mobile-bottom-nav md:hidden" id="mobile-bottom-nav" style="display: flex;">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="mobile-bottom-nav-item">
                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9"/></svg>
                Sign Out
            </button>
        </form>
    </nav>
