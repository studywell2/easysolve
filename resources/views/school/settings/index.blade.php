                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-5">
                            ...
                            <div class="flex-1">
                                ...
                                <input type="file" id="logo" name="logo" accept="image/jpeg,image/png,image/jpg,image/svg+xml,image/webp" class="hidden" onchange="document.getElementById('logo-file-name').textContent = this.files[0]?.name || ''; document.getElementById('logo-preview').src = this.files[0] ? URL.createObjectURL(this.files[0]) : ''; document.getElementById('logo-preview').classList.toggle('hidden', !this.files[0])">
